        ...
        },
        {
            ...
            options: {
                ...
                customBodyRender: (value, tableMeta, updateValue) => {
                    return (
                        <Button  className="btn btn-primary" onClick={()=> openModal(2, products.id, products.codigoproducto, products.nombreproducto, products.principioactivo, products.accionterapeutica, products.categoria, products.formafarmaceutica, products.carrucel, products.image, products.prospecto)}
