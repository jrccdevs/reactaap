    ...
    <div >
        ...
        <h5>EDITAR PRODUCTO</h5>
            <DialogContent >
                {/* <DialogContentText>Do you want remove this user?</DialogContentText> */}
                <Stack  spacing={2} margin={2}>
                <TextField variant="outlined" type='text' name="codigoproducto"  placeholder='Codigo Producto' label="Codigo Producto" onChange={handleChange} value={productoSeleccionado.codigoproducto}></TextField>
                <TextField variant="outlined" type='text' name="nombreproducto"  placeholder='Nombre Producto' label="Producto" onChange={handleChange} value={productoSeleccionado.nombreproducto}></TextField>
                <TextField variant="outlined" type='text' name="principioactivo"   placeholder='Principioactivo'  label="Principio Activo" onChange={handleChange}value={productoSeleccionado.principioactivo}></TextField>
                <TextField variant="outlined" type='text' name='accionterapeutica'  placeholder='Accionterapeutica'  label="Accion Terapeutica" onChange={handleChange} value={productoSeleccionado.accionterapeutica}></TextField>
                <FormControl>
                <InputLabel id="demo-mutiple-name-label">  Categoria</InputLabel>
               
                <Select
                    label="Categoria" type='text'   placeholder='Categoria' onChange={handleChange} value={productoSeleccionado.categoria}
                ...
                <TextField variant="outlined" type='text' name='formafarmaceutica'  placeholder='Formafarmaceutica'label="Forma Farmaceutica" onChange={handleChange} value={productoSeleccionado.formafarmaceutica}></TextField>
                <FormControl>
                <InputLabel id="demo-mutiple-name-label">  Carrucel</InputLabel>
                <Select
                 labelId="demo-mutiple-name-label"
                 id="demo-mutiple-name"
                    type='text' name="carrucel"  placeholder='carrucel' onChange={handleChange} value={productoSeleccionado.carrucel}
                     aria-label="Default select example"
                    label="carrucel"
                    variant="outlined">
                ...
                <TextField variant="outlined" type='text' name='presentacion' placeholder='presentacion'  label="Presentacion" onChange={handleChange} value={productoSeleccionado.presentacion}></TextField>
                <TextField variant="outlined" type='file' name='image'  placeholder='Imagen'  label="Image" onChange={handleChange} value={productoSeleccionado.image}></TextField>
                <TextField variant="outlined" type='file' name='prospecto ' placeholder='Prospecto' label="Prospecto" onChange={handleChange} value={productoSeleccionado.prospecto}></TextField>
    ...
    },
    {
        ...
        options: {
            ...
            customBodyRender: (value, tableMeta, updateValue) => {
                return (
                    <Button  className="btn btn-primary"  onClick= {() => seleccionarProducto(tableMeta.rowData, "Editar")}
		...
		<div >
			...
			<Dialog open={modalEditar} fullWidth maxWidth="sm">
				...
				<DialogContent >
					{/* <DialogContentText>Do you want remove this user?</DialogContentText> */}
					<Stack spacing={2} margin={2}>
						<TextField variant="outlined" type='text' name="codigoproducto" placeholder='Codigo Producto' label="Codigo Producto" onChange={handleChange} value={productoSeleccionado && productoSeleccionado.codigoproducto}></TextField>
