...
<Grid container>
  <Grid item xs={12} sm={12} md={6} lg={6} xl={6} sx={{marginTop:"-10px",justifyContent: "center", height:"auto", width:"auto"}}>
            <div className="imageresponsiv" style={{justifyContent: "center", width: "600px", height: 'auto', padding:"70px" }}>
