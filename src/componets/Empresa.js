                    ...
                    <div class="row">
                        ...
                        <div class="row mt-4">
                            <div class="col-6 col-md-4 text-center">
                                <img src={mision} width="300" height="300" class="rounded" alt="..." />
                                <h2>MISION</h2>
                            ...
                            <div class="col-6 col-md-4 text-center">
                                <img src={vision} width="300" height="300" class="rounded" alt="..." />
                                <h2>VISION</h2>
                            ...
                            <div class="col-6 col-md-4 text-center">
                                <img src={valores} width="300" height="300" class="rounded" alt="..." />
                                <h2>VALORES</h2>
                        ...
                        <p class="h1 text-center mb-4">Historia</p>
                        <div class="row mt-4">
                            <div class="col-6 col-md-5 text-center">
                                <img src={empresa} width="100%" height="100%" class="rounded" alt="..." />
                            </div>
                            <div class="col-6 col-md-7 text-center pt-4">
